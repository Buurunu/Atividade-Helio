...
package vilarim.repeticao.pkg04;

import javax.swing.JOptionPane;

public class VilarimRepeticao04 {
    ...
    public static void main(String[] args) {
        ...
        double cursoL = 0, cursoM = 0, cursoB = 0, totalDeAlunosMatri = 0,CR = 0,CRM = 0,CRP=0,CRR=0,maior = 0,menor = 10;
        ...
        JOptionPane.showMessageDialog(null, "Ultimo aluno cadastrado:"+pulo+ "Aluno n° " + nome + ", do curso de " + curso1
